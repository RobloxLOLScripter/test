<?php
  $n_sidebar_home = $blueprint->dbGet("velion", "sidebar_home");
  $n_sidebar_admin = $blueprint->dbGet("velion", "sidebar_admin");
  $n_sidebar_account = $blueprint->dbGet("velion", "sidebar_account");
  $n_sidebar_logout = $blueprint->dbGet("velion", "sidebar_logout");
  $n_sidebar_server_terminal = $blueprint->dbGet("velion", "sidebar_server_terminal");
  $n_sidebar_server_files = $blueprint->dbGet("velion", "sidebar_server_files");
  $n_sidebar_server_databases = $blueprint->dbGet("velion", "sidebar_server_databases");
  $n_sidebar_server_schedules = $blueprint->dbGet("velion", "sidebar_server_schedules");
  $n_sidebar_server_users = $blueprint->dbGet("velion", "sidebar_server_users");
  $n_sidebar_server_backups = $blueprint->dbGet("velion", "sidebar_server_backups");
  $n_sidebar_server_network = $blueprint->dbGet("velion", "sidebar_server_network");
  $n_sidebar_server_startup = $blueprint->dbGet("velion", "sidebar_server_startup");
  $n_sidebar_server_settings = $blueprint->dbGet("velion", "sidebar_server_settings");
  $n_sidebar_server_activity = $blueprint->dbGet("velion", "sidebar_server_activity");
  $n_sidebar_server_more = $blueprint->dbGet("velion", "sidebar_server_more");
  $n_sidebar_account_account = $blueprint->dbGet('velion', 'sidebar_account_account');
  $n_sidebar_account_api = $blueprint->dbGet('velion', 'sidebar_account_api');
  $n_sidebar_account_ssh = $blueprint->dbGet('velion', 'sidebar_account_ssh');
  $n_sidebar_account_activity = $blueprint->dbGet('velion', 'sidebar_account_activity');
  $n_sidebar_account_more = $blueprint->dbGet('velion', 'sidebar_account_more');
  $n_icon_scale = $blueprint->dbGet("velion", "icon_scale");
  $n_watermark = $blueprint->dbGet("velion", "watermark");
  $n_init = $blueprint->dbGet("velion", "init");
  $n_background_image = $blueprint->dbGet("velion", "background_image");
  $n_sidebar_background = $blueprint->dbGet("velion", "sidebar_background");
  $n_content_background = $blueprint->dbGet("velion", "content_background");
  $n_background_appearance = $blueprint->dbGet("velion", "background_appearance");
  $n_background_magic = $blueprint->dbGet("velion", "background_magic");
  $n_background_magicsize = $blueprint->dbGet("velion", "background_magicsize");
  $n_auth_background_image = $blueprint->dbGet("velion", "auth_background_image");
  $n_auth_background_appearance = $blueprint->dbGet("velion", "auth_background_appearance");
  $n_auth_background_magic = $blueprint->dbGet("velion", "auth_background_magic");
  $n_auth_background_magicsize = $blueprint->dbGet("velion", "auth_background_magicsize");
  $n_palette_dashboard_1 = $blueprint->dbGet("velion", "palette_dashboard_1");
  $n_palette_dashboard_2 = $blueprint->dbGet("velion", "palette_dashboard_2");
  $n_palette_dashboard_3 = $blueprint->dbGet("velion", "palette_dashboard_3");
  $n_palette_dashboard_4 = $blueprint->dbGet("velion", "palette_dashboard_4");
  $n_palette_dashboard_5 = $blueprint->dbGet("velion", "palette_dashboard_5");
  $n_palette_dashboard_6 = $blueprint->dbGet("velion", "palette_dashboard_6");
  $n_palette_dashboard_7 = $blueprint->dbGet("velion", "palette_dashboard_7");
  $n_palette_dashboard_8 = $blueprint->dbGet("velion", "palette_dashboard_8");
  $n_palette_dashboard_9 = $blueprint->dbGet("velion", "palette_dashboard_9");
  $n_palette_sidebar_1 = $blueprint->dbGet("velion", "palette_sidebar_1");
  $n_palette_sidebar_2 = $blueprint->dbGet("velion", "palette_sidebar_2");
  $n_palette_sidebar_3 = $blueprint->dbGet("velion", "palette_sidebar_3");
  $n_palette_sidebar_4 = $blueprint->dbGet("velion", "palette_sidebar_4");
  $n_palette_sidebar_5 = $blueprint->dbGet("velion", "palette_sidebar_5");
  $n_palette_sidebar_6 = $blueprint->dbGet("velion", "palette_sidebar_6");
  $n_palette_sidebar_7 = $blueprint->dbGet("velion", "palette_sidebar_7");
  $n_palette_sidebar_8 = $blueprint->dbGet("velion", "palette_sidebar_8");
  $n_palette_auth_1 = $blueprint->dbGet("velion", "palette_auth_1");
  $n_palette_auth_2 = $blueprint->dbGet("velion", "palette_auth_2");
  $n_palette_auth_3 = $blueprint->dbGet("velion", "palette_auth_3");
  $n_palette_auth_4 = $blueprint->dbGet("velion", "palette_auth_4");
  $n_palette_auth_5 = $blueprint->dbGet("velion", "palette_auth_5");
  $n_palette_auth_6 = $blueprint->dbGet("velion", "palette_auth_6");
  $n_palette_auth_7 = $blueprint->dbGet("velion", "palette_auth_7");
  $n_palette_auth_8 = $blueprint->dbGet("velion", "palette_auth_8");
  $n_keyboard_shortcuts = $blueprint->dbGet("velion", "keyboard_shortcuts");
  $n_keybind_icons = $blueprint->dbGet("velion", "keybind_icons");
  $n_sidebar_hover_tooltip = $blueprint->dbGet("velion", "sidebar_hover_tooltip");
  $n_server_overview_graphs = $blueprint->dbGet("velion", "server_overview_graphs");
  $n_server_colored_power = $blueprint->dbGet("velion", "server_colored_power");
  $n_sidebar_always_visible_buttons = $blueprint->dbGet("velion", "sidebar_always_visible_buttons");
  $n_icon_fallback = $blueprint->dbGet("velion", "icon_fallback");
  $n_dashboard_transparency = $blueprint->dbGet("velion", "dashboard_transparency");
  $n_page_indexing = $blueprint->dbGet("velion", "page_indexing");
  $n_website_links = $blueprint->dbGet("velion", "website_links");
  $n_weblink_support = $blueprint->dbGet("velion", "weblink_support");
  $n_weblink_billing = $blueprint->dbGet("velion", "weblink_billing");
  $n_weblink_status = $blueprint->dbGet("velion", "weblink_status");
  $n_weblink_social_discord = $blueprint->dbGet("velion", "weblink_social_discord");
  $n_weblink_social_github = $blueprint->dbGet("velion", "weblink_social_github");
  $n_website_links_align = $blueprint->dbGet("velion", "website_links_align");
  $n_alert = $blueprint->dbGet("velion", "alert");
  $n_alert_text = $blueprint->dbGet("velion", "alert_text");
  $n_alert_icon = $blueprint->dbGet("velion", "alert_icon");
  $n_watermark_auth = $blueprint->dbGet("velion", "watermark_auth");
  $n_server_list = $blueprint->dbGet("velion", "server_list");
  $n_reset = $blueprint->dbGet("velion", "reset");
  $n_border_radius = $blueprint->dbGet("velion", "border_radius");
  $n_sidebar_full = $blueprint->dbGet("velion", "sidebar_full");
  $n_sidebar_buttonstyle = $blueprint->dbGet("velion", "sidebar_buttonstyle");
  $n_sidebar_customlogo = $blueprint->dbGet("velion", "sidebar_customlogo");
  $n_auth_customlogo = $blueprint->dbGet("velion", "auth_customlogo");
  $n_alert_position = $blueprint->dbGet("velion", "alert_position");
  $n_sidebar_border_radius = $blueprint->dbGet("velion", "sidebar_border_radius");
  $n_alert_dismiss = $blueprint->dbGet("velion", "alert_dismiss");
  $n_palette_status_offline = $blueprint->dbGet("velion", "palette_status_offline");
  $n_palette_status_error = $blueprint->dbGet("velion", "palette_status_error");
  $n_palette_status_starting = $blueprint->dbGet("velion", "palette_status_starting");
  $n_palette_status_online = $blueprint->dbGet("velion", "palette_status_online");
  $n_statusgradient_style = $blueprint->dbGet("velion", "statusgradient_style");
  $n_sidebar_hover = $blueprint->dbGet("velion", "sidebar_hover");
...
@include('blueprint.extensions.velion.wrapper.links')
@include('blueprint.extensions.velion.wrapper.alerts')
@include('blueprint.extensions.velion.wrapper.theme.icons')

@if(Auth::check())
@if($n_watermark == "1")
<p class="velionFooter"><a href="#" class="velionFooter"><i style="font-size:12px; margin-right: 3px;" class="bi bi-exclude"></i> Poháněno Velion.</a></p>
@endif
<div
  <?php
...
@include('blueprint.extensions.velion.wrapper.contextmenu.files')
@include('blueprint.extensions.velion.wrapper.contextmenu.more')
@include('blueprint.extensions.velion.wrapper.contextmenu.sidebar')

@endif
<style id="velion-components">
